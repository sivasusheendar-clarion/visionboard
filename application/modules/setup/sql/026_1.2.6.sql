...
ALTER TABLE `fi_quote_amounts` ADD `quote_item_subtotal` DECIMAL( 10, 2 ) NOT NULL AFTER `quote_id` ,
ADD `quote_item_tax_total` DECIMAL( 10, 2 ) NOT NULL AFTER `quote_item_subtotal` ,
ADD `quote_tax_total` DECIMAL( 10, 2 ) NOT NULL AFTER `quote_item_tax_total`;

ALTER TABLE `fi_quote_items` ADD `item_tax_rate_id` INT NOT NULL AFTER `quote_id` ,
ADD INDEX ( `item_tax_rate_id` );

ALTER TABLE `fi_quote_item_amounts` ADD `item_subtotal` DECIMAL( 10, 2 ) NOT NULL AFTER `item_id` ,
